 ...
 * 平面几何体
 */
export default class PlaneGeometry extends BaseGeometry<IConfig> {
    ...
    public static readonly uv: ArrayAttribute<Float32Array<ArrayBuffer>> =
        new ArrayAttribute(new Float32Array([0, 0, 1, 0, 1, 1, 0, 1]), 2);
    /**
     * 默认顶点索引
     */
    public static readonly index: ArrayAttribute<Uint16Array<ArrayBuffer>> =
        new ArrayAttribute(new Uint16Array([0, 1, 2, 0, 2, 3]), 3);
     ...
     * 尺寸属性
     */
    public readonly size: Vector2 = PlaneGeometry.size
        .clone()
