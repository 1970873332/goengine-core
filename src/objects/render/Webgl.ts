...
import { BlendType, SideType, UniformKey, UniformType } from "../../enum/GLSL";
...
export default class WebglRenderer {
    declare protected gl: GLSL.WebGLAllRenderingContext;
    /**
     * 缓冲缓存
     */
     ...
     * @param material
     */
    protected applyRenderMode(state: State, material: BaseMaterial): void {
     ...
     * @returns
     */
    public renderNode(node: Mesh<any, any>, camera: Camera): void {
        const {
            material: { value: material },
            geometry: { value: geometry },
        } = node as Mesh<BaseGeometry, BaseMaterial>;
