...
import { TaskComponentEvent } from "../../components/Task";
import MessageQueueManager, {
    MessageQueueManagerEvent,
} from "../../managers/MessageQueue";
import { ArrayUtils } from "../../utils/Array";
import ResponseAttribute from "../attribute/Response";
import { Euler, Quaternion, Vector3 } from "../math/Index";
import { EulerType } from "../math/transfrom/Euler";
...
> extends DuplicatableComponent<E, Func.CallBack<BaseNode<C, E>>> {
     ...
     * 父节点
     */
    public readonly parent: ResponseAttribute<BaseNode | undefined> =
        new ResponseAttribute(void 0);
    /**
     * 消息队列
     */
    public readonly messageQueue: ResponseAttribute<
        MessageQueueManager | undefined
    > = new ResponseAttribute(void 0);
    /**
     * 位置
     */
    public readonly position: Vector3 = new Vector3().bindCallback(
        this.positionCallback.bind(this),
    );
    /**
     * 锚点
     */
    public readonly anchor: Vector3 = new Vector3().bindCallback(
        this.anchorCallback.bind(this),
    );
    /**
     * 缩放
     */
    public readonly scale: Vector3 = new Vector3(1, 1, 1).bindCallback(
        this.scaleCallback.bind(this),
    );
    /**
     * 旋转
     */
    public readonly rotation: Euler = new Euler().bindCallback(
        this.rotationCallback.bind(this),
    );
    /**
     * 四元数
     */
    public readonly quaternion: Quaternion = new Quaternion().bindCallback(
        this.quaternionCallback.bind(this),
    );
    /**
     * 子项
     */
    public readonly children: Map<string, BaseNode> = new Map();
    /**
     * 是否可见
     */
    public readonly visible: ResponseAttribute<boolean> = new ResponseAttribute(
        true,
     ...
     * @param parent
     */
    public bindParent(parent: BaseNode): this {
    ...
    public unbindMessageQueue(): this {
        ...
        this.children.forEach((child: BaseNode) => child.unbindMessageQueue());
        return this;
    }
    /**
     * 旋转回调
     ...
     * @param node
     */
    public add(...nodes: BaseNode[]): this {
        nodes.forEach((item: BaseNode) => {
     ...
     * @param callback
     */
    public traverse(callback: (node: BaseNode) => void): void {
    ...
    public getNodeByID(id: string): BaseNode | undefined {
        let node: BaseNode | undefined = this.children.get(id);
    ...
    public clear(destory?: boolean): void {
        this.children.forEach((item: BaseNode) =>
    ...
    public reInit(): void {
        this.anchor.reBindCallback(this.anchorCallback.bind(this));
        this.position.reBindCallback(this.positionCallback.bind(this));
        this.scale.reBindCallback(this.scaleCallback.bind(this));
        this.rotation.reBindCallback(this.rotationCallback.bind(this));
        this.quaternion.reBindCallback(this.quaternionCallback.bind(this));
        this.visible.reBindCallback(this.visibleCallback.bind(this));
    }
}
...
interface ISaveJSON extends Partial<
    Pick<BaseNode, "uuid" | "disableHelper" | "instruct" | "controlled">
> {
    /**
     * 类型
     */
