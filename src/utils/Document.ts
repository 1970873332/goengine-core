...
export abstract class DocumentUtils {
        ...
        return (
            ...
            this.setToElement(
                this.createElement("div", {
                    id: EIDMap.ROOT_WRAP,
                    className: "only-subitems-events full-all absolute-full",
                }),
                {
                    zIndex: 1,
        ...
        return (
            ...
            this.setToElement(
                this.createElement("canvas", {
                    ...
                    className: "full-all absolute-full",
                    oncontextmenu: () => false,
                }),
                {
     ...
     * 获取Matter2D模拟canvas
     */
    public static get matterCanvas(): HTMLCanvasElement {
        return (
            this.getElement(EIDMap.MATTER_CANVAS) ??
            this.setToElement(
                this.createElement("canvas", {
                    id: EIDMap.MATTER_CANVAS,
