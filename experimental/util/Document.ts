...
export abstract class DocumentUtils {
        ...
        return (
            ...
            this.setToElement(
                ...
                }),
                {
                    ...
                    callback: DocumentUtils.syncCanvasClientSize,
     ...
     * @returns
     */
    protected static getElement<T extends HTMLElement>(id: string): T | null {
    ...
    public static createTextureCanvas(
        ...
        options && DocumentUtils.syncCanvasClientSize(canvas);
        return canvas;
    }
    /**
     * 同步canvas尺寸
     * @param canvas
     */
    public static syncCanvasClientSize(canvas: HTMLCanvasElement): void {
